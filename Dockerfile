...
# Configure zsh
COPY --chown=workstation:workstation zshrc /home/workstation/.zshrc
...
COPY --chown=workstation:workstation vimrc /home/workstation/.vim_runtime/my_configs.vim

# Configure tmux
RUN git clone https://github.com/gpakosz/.tmux.git
RUN ln -s -f .tmux/.tmux.conf
COPY --chown=workstation:workstation tmux.conf /home/workstation/.tmux.conf.local
